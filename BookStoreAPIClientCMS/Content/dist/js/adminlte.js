...
window.addEventListener('load', function() {
  ...
  $(".main-sidebar .nav-item > a.nav-link[href$='"+ controller + "']").parents('li.nav-item').addClass('menu-is-opening menu-open');
  $(".main-sidebar .nav-item > a.nav-link[href$='"+ controller + "']").parents('.nav-treeview').prevAll('.nav-link').addClass('active');
  $(".main-sidebar .nav-item > a.nav-link[href$='"+ controller + "']").addClass("active")
})